...
<div class="overflow-auto">
    ...
    <div class="mb-5">
        <textarea bind:value={title} class="w-full h-7 border border-gray-200 rounded py-2 mb-5" placeholder="Title"></textarea>
        <textarea bind:value={description} class="w-full h-96 border border-gray-200 rounded py-2 mb-5" placeholder="Description (Markdown is supported)"></textarea>
