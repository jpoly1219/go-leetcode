    ...
    <div class="rounded-lg shadow-lg w-1/3 my-44">
        ...
        <form on:submit|preventDefault={submit} class="flex flex-col">
            <div class="flex flex-col items-stretch">
                ...
                <input bind:value={newEmail} type="email" placeholder="New email address" required class="border-b-2 py-4">
                <input bind:value={newPassword} type="password" placeholder="New password" required class="border-b-2 py-4">
                <input bind:value={confirmPassword} type="password" placeholder="Confirm password" required pattern={newPassword} class="border-b-2 py-4">
            </div>
